...
<head>
    ...
    <title>Painel Hoogli - Adicionar Filme</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Adicionar Filme</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                      ...
                                      <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea name="descricao" class="form-control" id="" cols="30" rows="4"></textarea>
                                                </div>
                                            </div>                                        
                                        </div>
                                        <br>
                                    ...
                                    <input type="hidden" name="acao" value="addFilme">
                                </form>
                            </div>
                        </div>
                    </div>
