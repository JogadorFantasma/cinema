...
$id = '';
if(isset($_POST['url_filme'])){
    if(empty($_POST['url_filme'])){
        header('Location: baixar-cadeira.php');
    }else{
        $id = $_POST['url_filme'];        
    }
}
$data_ingresso = $_POST['data_filme'];
$horario_ingresso = $_POST['hora_filme'];
$descFilme = $filmes->rsDados('', '', '', $id);
$dadosDaProgramacao = $filmes->rsDadosProgramacao('', '', '', $descFilme[0]->id, $data_ingresso, '', $horario_ingresso, $_POST['id_cidade']);
...
<head>
    ...
    <title>Painel Hoogli - Mostrar Cadeiras</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Mostrar Cadeiras</h4>
                  ...
                  <div class="single-sidebar">
                    <div class="widget">
                      ...
                      <div class="sidebar-content">
                       <div class="row">
                        <div class=" col-md-4 sidebar-image siixx">
                          <img src="../img/<?php echo $descFilme[0]->imagem?>" alt="<?php echo $descFilme[0]->url_amigavel;?>" title="<?php echo $descFilme[0]->url_amigavel;?>" width="150">
                        ...
                        <div class="wizard-heading ">
                          ...
                          <div class="selected-seat">
                              <ul>
                                ...
                                <li><span></span>Assentos Especiais</li>
                              </ul>
                            </div>
                            <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 3 && $_POST['id_cidade'] == 4){?>
                            <!-- SALA 1 SOBRADINHO -->
                            ...
                            <a class="btn btn-warning"  href="baixar-cadeira.php"><i class="fa fa-angle-left" aria-hidden="true"></i> Voltar Início</a>
                              <button class="btn btn-primary" type="submit">Finalizar Baixa<i class="fa fa-angle-right" aria-hidden="true"></i></button>
                              <input type="hidden" name="quantidade_ingresso_inteira" value="<?php echo $_POST['quantidade_ingresso_inteira'];?>">
                              <input type="hidden" name="quantidade_ingresso_meia" value="<?php echo $_POST['quantidade_ingresso_meia'];?>">
                              <input type="hidden" name="url_filme" value="<?php echo $_POST['url_filme'];?>">
                              <input type="hidden" name="id_filme" value="<?php echo $_POST['id_filme'];?>">
                              <input type="hidden" name="data_filme" value="<?php echo $_POST['data_filme'];?>">
                              <input type="hidden" name="hora_filme" value="<?php echo $_POST['hora_filme'];?>">
                              <input type="hidden" name="id_sala" value="<?php echo $_POST['id_sala'];?>">
                              <input type="hidden" name="id_cidade" value="<?php echo $_POST['id_cidade'];?>">
                              <input type="hidden" name="valor_inteira" value="<?php echo $_POST['valor_inteira'];?>">
                              <input type="hidden" name="valor_meia" value="<?php echo $_POST['valor_meia'];?>">
                              <input type="hidden" name="id_usuario" value="<?php echo $dadosUsuarioLogado->id;?>">
                              <input type="hidden" name="acao" value="addBaixa">
                            </form>
                            <?php }?>

                            <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 8 && $_POST['id_cidade'] == 4){?>
                            <!-- SALA 2 SOBRADINHO -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 9 && $_POST['id_cidade'] == 4){?>
                            <!-- SALA 3 SOBRADINHO -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php }?>
                             ...
                             <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 6 && $_POST['id_cidade'] == 5){?>
                             <!-- SALA 1 BARREIRAS -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php }?>
                            <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 7 && $_POST['id_cidade'] == 5){?>
                             <!-- SALA 2 BARREIRAS -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php }?>
                              ...
                              <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 2 && $_POST['id_cidade'] == 2){?>
                              <!-- SALA 1 LEM -->
                              <style>
                                    .seats .seats-table .table-responsive .table tbody style="text-align: center;" tr td {
                            ...
                            <?php }?>
                             ...
                             <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 5 && $_POST['id_cidade'] == 2){?>
                           <!-- SALA 2 LEM -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php }?>
                              ...
                              <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 1 && $_POST['id_cidade'] == 1){?>
                           <!-- SALA 1 FORMOSA -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                                    ...
                                    <tr>
                                     ...
                                     <?php if(count($cadeiraD3)){?>
                                      ...
                                      <?php if(count($cadeiraD7)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="D7"/>57/td>
                                      <?php }?>
                                      <?php if(count($cadeiraD8)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                            ...
                            <?php }?>
                              <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 4 && $_POST['id_cidade'] == 1){?>
                           <!-- SALA 2 FORMOSA -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 10 && $_POST['id_cidade'] == 6){?>
                            <!-- SALA 1 GUANAMBI -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            $cadeiraD16 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'D16');
                            $cadeiraD17 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'D17');
                            $cadeiraD18 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'D18');
                            ...
                            $cadeiraB16 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'B16');
                            $cadeiraB17 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'B17');
                            $cadeiraB18 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'B18');

                            $cadeiraA4 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'A4');
                            $cadeiraA5 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'A5');
                            $cadeiraA10 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'A10');
                            $cadeiraA11 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'A11');
                                  ...
                                  <tbody style="text-align: center;"> 
                                    ...
                                    <tr>
                                      ...
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="D17"/>17</td>
                                      <?php }?>
                                       <?php if(count($cadeiraD18)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="D18"/>18</td>
                                      <?php }?>
                                      <td class="white-space"></td>
                                      <td class="white-space"></td>
                                      <td class="white-space"></td>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                      ...
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="B17"/>17</td>
                                      <?php }?>
                                       <?php if(count($cadeiraB18)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="B18"/>18</td>
                                      <?php }?>
                                       <td class="white-space"></td>
                                      <td class="white-space"></td>
                                       <td class="white-space"></td>
                                    ...
                                    <tr>
                                      ...
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="A4"/>4</td>
                                      <?php }?>
                                      <?php if(count($cadeiraA5)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="A5"/>5</td>
                                      <?php }?>
                                      <td class="white-space"></td>
                                      <td class="white-space"></td>
                            ...
                            <?php if(isset($_POST['id_sala']) && $_POST['id_sala'] == 11 && $_POST['id_cidade'] == 6){?>
                            <!-- SALA 2 GUANAMBI -->
                            <form action="" name="form" method="POST">
                            <?php //var_dump($_POST);

                            $cadeiraK2 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'K2');
                            $cadeiraK3 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'K3');
                            $cadeiraK9 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'K9');
                            $cadeiraK10 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'K10');
                            $cadeiraK13 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'K13');
                            $cadeiraK14 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'K14');
                            ...
                            $cadeiraH4 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'H1');
                            $cadeiraH5 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'H2');
                            $cadeiraH7 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'H3');
                            $cadeiraH8 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'H8');
                            $cadeiraH11 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'H9');
                            $cadeiraH12 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'H12');
                            
                            $cadeiraG1 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'G1');
                            $cadeiraG2 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'G2');
                            $cadeiraG3 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'G3');
                            $cadeiraG9 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'G9');
                            $cadeiraG10 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'G10');
                            $cadeiraG13 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'G13');
                            $cadeiraG14 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'G14');
                            
                            $cadeiraF5 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'F1');
                            $cadeiraF7 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'F2');
                            $cadeiraF8 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'F3');
                            $cadeiraF11 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'F8');
                            $cadeiraF12 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'F12');
                            
                            $cadeiraE3 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'E3');
                            $cadeiraE4 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'E4');
                            $cadeiraE5 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'E5');
                            $cadeiraE9 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'E9');
                            $cadeiraE10 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'E10');
                            $cadeiraE13 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'E13');
                            $cadeiraE14 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'E14');
                            
                            $cadeiraD7 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'D1');
                            $cadeiraD8 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'D2');
                            $cadeiraD11 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'D9');
                            $cadeiraD12 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'D12');
                            
                            $cadeiraC3 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'C3');
                            $cadeiraC4 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'C4');
                            $cadeiraC5 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'C5');
                            $cadeiraC9 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'C9');
                            $cadeiraC10 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'C10');
                            $cadeiraC13 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'C13');
                            $cadeiraC14 = $compras->rsDadosAssentos('', '', '', '', $descFilme[0]->id, $horario_ingresso, $data_ingresso, $_SESSION['id_cidade'], 'C14');
                                ...
                                <table class="table">
                                  <tbody style="text-align: center;"> 
                                    ...
                                    <tr>
                                      ...
                                      <td class="number">K</td>
                                      <?php if(count($cadeiraK2)){?>
                                        <td class="selected-seat click-seat" style="width: 40px;"></td>
                                      <?php }else{?>
                                        <td class="free-seat-especiais click-seat" style="width: 40px;"><input type="checkbox" name="cadeira[]" value="K2"/></td>
                                      <?php }?>
                                      <?php if(count($cadeiraK3)){?>
                                        <td class="selected-seat click-seat" style="width: 40px;"></td>
                                      <?php }else{?>
                                        <td class="free-seat-especiais click-seat" style="width: 40px;"><input type="checkbox" name="cadeira[]" value="K3"/></td>
                                      <?php }?>
                                      <td class="unavailable click-seat" style="width: 41px;"></td>
                                      <td class="unavailable click-seat" style="width: 41px;"></td>
                                      <td class="white-space"></td>
                                      <td class="white-space"></td>
                                      <td class="white-space"></td>
                                      <?php if(count($cadeiraK9)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="K9"/>9</td>
                                      <?php }?>
                                      <?php if(count($cadeiraK10)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="K10"/>10</td>
                                      <?php }?>
                                      <td class="unavailable click-seat"></td>
                                      <td class="unavailable click-seat"></td>
                                       <?php if(count($cadeiraK13)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="K13"/>13</td>
                                      <?php }?>
                                       <?php if(count($cadeiraK14)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="K14"/>14</td>
                                      <?php }?>
                                      <td class="number">K</td>
                                    </tr> 
                                    <tr>
                                      ...
                                      <td class="white-space"></td>
                                      <td class="number">J</td>
                                      <td class="unavailable click-seat" style="width: 40px;"></td>
                                      <td class="unavailable click-seat" style="width: 40px;"></td>
                                      <?php if(count($cadeiraJ4)){?>
                                        <td class="selected-seat click-seat" style="width: 41px;"></td>
                                      <?php }else{?>
                                        <td class="free-seat-especiais click-seat" style="width: 41px;"><input type="checkbox" name="cadeira[]" value="J4"/></td>
                                      <?php }?>
                                      <?php if(count($cadeiraJ5)){?>
                                        <td class="selected-seat click-seat" style="width: 41px;"></td>
                                      <?php }else{?>
                                        <td class="free-seat-especiais click-seat" style="width: 41px;"><input type="checkbox" name="cadeira[]" value="J5"/></td>
                                      <?php }?>
                                      <td class="white-space"></td>
                                      <td class="white-space"></td>
                                       <?php if(count($cadeiraJ8)){?>
                                    ...
                                    <tr>
                                      ...
                                      <td class="number">I</td>
                                      <?php if(count($cadeiraI2)){?>
                                        <td class="selected-seat click-seat" style="width: 66px;"></td>
                                      <?php }else{?>
                                        <td class="free-seat-especiais click-seat" style="width: 66px;"><input type="checkbox" name="cadeira[]" value="I2"/></td>
                                      <?php }?>
                                      <?php if(count($cadeiraI3)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                    ...
                                    <tr>
                                      ...
                                      <td class="white-space"></td>
                                      <td class="number">H</td>
                                      <td class="unavailable click-seat" style="width: 66px;"></td>
                                      <td class="unavailable click-seat"></td>
                                      <?php if(count($cadeiraH4)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                    ...
                                    <tr>
                                      ...
                                      <td class="unavailable click-seat"></td>
                                      <td class="unavailable click-seat"></td>
                                      <?php if(count($cadeiraG9)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="G9"/>9</td>
                                      <?php }?>
                                      <?php if(count($cadeiraG10)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                    ...
                                    <tr>
                                      ...
                                      <td class="unavailable click-seat"></td>
                                      <td class="unavailable click-seat"></td>
                                      <?php if(count($cadeiraE9)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="E9"/>9</td>
                                      <?php }?>
                                      <?php if(count($cadeiraE10)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                    ...
                                    <tr>
                                      ...
                                      <td class="unavailable click-seat"></td>
                                      <td class="unavailable click-seat"></td>
                                      <?php if(count($cadeiraC9)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
                                        <td class="free-seat click-seat"><input type="checkbox" name="cadeira[]" value="C9"/>9</td>
                                      <?php }?>
                                      <?php if(count($cadeiraC10)){?>
                                        <td class="selected-seat click-seat"></td>
                                      <?php }else{?>
