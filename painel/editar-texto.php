...
$textos->editar();
$editaTexto = $usuarios->rsDados($id);
?>
<!DOCTYPE html>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <textarea name="texto" class="form-control" id="" cols="30" rows="10"><?php if(isset($editaTexto->texto) && !empty($editaTexto->texto)){ echo $editaTexto->texto;}?></textarea>
