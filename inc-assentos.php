 <div class="selected-seat">
                            ...
                            <?php }?>
                            <?php if(isset($_GET['id_sala']) && $_GET['id_sala'] == 7 && $_GET['id_cidade_sala'] == 5){?>
                             <!-- SALA 2 BARREIRAS -->
                            <form action="<?php echo SITE_URL;?>/entrada/3/<?php echo $descFilme[0]->url_amigavel;?>" name="form" method="POST">
                            <?php //var_dump($_POST);
                           ...
                           <!-- SALA 2 LEM -->
                            ...
                            <?php }?>
                              ...
                              <?php if(isset($_GET['id_sala']) && $_GET['id_sala'] == 1 && $_GET['id_cidade_sala'] == 1){?>
                           <!-- SALA 1 FORMOSA -->
                            <form action="<?php echo SITE_URL;?>/entrada/3/<?php echo $descFilme[0]->url_amigavel;?>" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php }?>
                              <?php if(isset($_GET['id_sala']) && $_GET['id_sala'] == 4 && $_GET['id_cidade_sala'] == 1){?>
                           <!-- SALA 2 FORMOSA -->
                            <form action="<?php echo SITE_URL;?>/entrada/3/<?php echo $descFilme[0]->url_amigavel;?>" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php if(isset($_GET['id_sala']) && $_GET['id_sala'] == 10 && $_GET['id_cidade_sala'] == 6){?>
                            <!-- SALA 1 GUANAMBI -->
                            <form action="<?php echo SITE_URL;?>/entrada/3/<?php echo $descFilme[0]->url_amigavel;?>" name="form" method="POST">
                            <?php //var_dump($_POST);
                            ...
                            <?php if(isset($_GET['id_sala']) && $_GET['id_sala'] == 11 && $_GET['id_cidade_sala'] == 6){?>
                            <!-- SALA 2 GUANAMBI -->
                            <form action="<?php echo SITE_URL;?>/entrada/3/<?php echo $descFilme[0]->url_amigavel;?>" name="form" method="POST">
                            <?php //var_dump($_POST);
