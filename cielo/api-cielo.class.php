...
if(empty($ApisCielosInstanciada)) {
   ...
   if(isset($_POST['acao']) && $_POST['acao'] == 'pagamentoCartaoCreditoMinimo'){
 $nome = filter_input(INPUT_POST, 'senderName', FILTER_SANITIZE_STRING);
    ...
    if(isset($_SESSION['id_cidade']) && $_SESSION['id_cidade'] == 5){
      //barreiras
      $merchant_id_cielo = '5c3a7fe9-2ea0-481e-80d9-e1a00ddf211e';
      $merchant_key_cielo = '4woHiHbk5bGvdyLuucH0no5UF7jQnk3FfI1Y6agq';
    }
    if(isset($_SESSION['id_cidade']) && $_SESSION['id_cidade'] == 1){
      //formosa
      $merchant_id_cielo = '8c8ae37c-c8b5-4663-aae0-220af0d0d41f';
      $merchant_key_cielo = 'cIuUbBXKMg2HMoxAROaC0NHAgY9KSfGt3lim7H2a';
    }
    if(isset($_SESSION['id_cidade']) && $_SESSION['id_cidade'] == 2){
      //lem
      $merchant_id_cielo = '9a056009-46ef-47c7-9c7f-e8afa8cf7236';
      $merchant_key_cielo = 'geJH3xjruoIOX5jHFucg0jxtkh2DN1IeNj8LHKND';
    }
    if(isset($_SESSION['id_cidade']) && $_SESSION['id_cidade'] == 6){
      //guanambi
      $merchant_id_cielo = '9a056009-46ef-47c7-9c7f-e8afa8cf7236';
      $merchant_key_cielo = 'geJH3xjruoIOX5jHFucg0jxtkh2DN1IeNj8LHKND';
    }
    if(isset($_SESSION['id_cidade']) && $_SESSION['id_cidade'] == 4){
      //sobradinho
      $merchant_id_cielo = '01b01868-114c-4336-bb60-8d67aef6c5b2';
      $merchant_key_cielo = 'MKMIupe87B6ebq7Mto8uSLjNtZ7eDZSlciqw7z5T';
      /* $merchant_id_cielo = 'cb41cfa2-04ea-4a98-baba-965ea6596149';
      $merchant_key_cielo = 'ZWEOPLOHJOKTBMSUQKWCQGXHZUYJQHLGGLFAFJOA'; */
    }
