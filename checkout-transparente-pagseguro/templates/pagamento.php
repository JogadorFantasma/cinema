...
<div class="col-md-4" >
    ...
    <div id="dadosOtherPagador" class="dadosOtherPagador">
        ...
        <div id="holderData">
          ...
          <div class="field" style="display: none">
            ...
            <input type="text" name="billingAddressCountry" id="billingAddressCountry" value="Brasil" readonly />
          </div>
  ...
  <center>
    ...
    <img src="checkout-transparente-pagseguro/images/banner-pagseguro.png" style="float:left; margin-top:50px;"/>
  </center>
