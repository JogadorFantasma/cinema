...
$mail = new PHPMailer();
                      ...
                      <table align='center' role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'
                                                  ...
                                                  <tr>
                                                      <td style='text-align: left; padding-left: 5px; padding-right: 5px;'>
                                                          ...
                                                          <ul>
                                                              ...
                                                              <li><span class='text'>(61) 3718-1502</span></li>
                                                              <li><span class='text'>(61) 9 8438-0807</span></a></li>
                                                              <li><span class='text'>contato@itiquira.com.br</span></a></li>
                                                          </ul>
                                                      </td>
                                                  </tr>
                                              </table>
                          ...
                          <tr>
                              <td class='bg_light' style='text-align: center;'>
                                  <p>Copyright © 2020 Itiquira Park - Todos os direitos reservados</p>
                              </td>
                          </tr>
                      </table>
		  ...
		  try {
			...
			// $mail->SMTPSecure = "ssl";// sets the prefix to the servier
			 ...
			 $mail->Username   = "itiquira";// GMAIL username
			 ...
			 $mail->SetFrom('contato@itiquira.com.br', 'Itiquira Park');
			 $mail->Subject = 'CONFIRMAÇÃO DE RESERVA - Itiquira Park';
